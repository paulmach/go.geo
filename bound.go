...
func (b Bound) Union(other Bound) Bound {
	b = b.Extend(other.SouthWest())
	b = b.Extend(other.NorthWest())
	b = b.Extend(other.SouthEast())
	return b.Extend(other.NorthEast())
}
...
func (b Bound) Equal(c Bound) bool {
	if b.sw.Equal(c.sw) && b.ne.Equal(c.ne) {
		return true
	}
