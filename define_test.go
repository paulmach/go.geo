...
func TestDefineYesHaversine(t *testing.T) {
	...
	if yesHaversine(make([]bool, 0)) {
		t.Errorf("define, yesHaversine should be false, got true")
	}

	if !yesHaversine([]bool{true}) {
		t.Errorf("define, yesHaversine should be true, got false")
	}
